...
from rubick import RubickCube, expand_states, expand_state
...
def search(start, heuristic, max_iterations=10_000):
    ...
    for _ in range(max_iterations):
        ...
        neighbour_states = current_node.neighbour_states()
        ...
        for a in range(12):
            ...
            if node._cube.is_solved():
                parents[node] = (current_node, a)
                return _reconstruct_path(node, parents)
...
#         children, _ = env.expand_state(current)
